...
class HiddenMarkovModel(BayesNetwork):
    ...
    initial_distribution: Optional[UncondDist]
    transition_distribution: Optional[CondDist]
    emission_distribution: Optional[CondDist]
    ...
    def set_initial_distribution(self, initial_distribution: UncondDist) -> None:
    ...
    def set_transition_distribution(self, transition_distribution: CondDist) -> None:
    ...
    def set_emission_distribution(self, emission_distribution: CondDist) -> None:
